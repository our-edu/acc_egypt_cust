...
// Modified: Custom General Ledger — party/party_type filter searches both
// GL Entry (party/party_type) and Journal Entry accounts (custom_party/custom_party_type).
	...
	filters: [
		...
		},
		{
			...
			get_data: function (txt) {
				...
				// Search across both the standard doctype AND Journal Entry custom_party field
				// so that parties entered via custom_party are discoverable.
